...
public class CustomBedBlockEntityRenderer implements BlockEntityRenderer<CustomBedBlockEntity>
{
    ...
    {
        SpriteIdentifier spriteIdentifier = ModTexturedRenderLayers.BED_TEXTURES[bedBlockEntity.getColor().getId()];
        World world = bedBlockEntity.getWorld();
        if (world != null)
        {
            BlockState blockState = bedBlockEntity.getCachedState();
            DoubleBlockProperties.PropertySource<? extends CustomBedBlockEntity> propertySource = DoubleBlockProperties.toPropertySource(
                    ModBlockEntities.CUSTOM_BED,
                    CustomBedBlock::getBedPart,
                    CustomBedBlock::getOppositePartDirection,
                    ChestBlock.FACING,
                    blockState,
                    world,
            ...
            this.renderPart(
                    ...
                    blockState.get(CustomBedBlock.PART) == BedPart.HEAD ? this.bedHead : this.bedFoot,
                    blockState.get(CustomBedBlock.FACING),
                    spriteIdentifier,
                    k,
                    j,
                    false);
